            ...
            <div class="sm:col-span-9">
              <div class="flex items-center gap-5">
                <div class="z-10 size-16 rounded-full overflow-x-hidden">
                  <img id="profileImagePreview" class="inline-block absolute h-[4rem] max-w-[4rem] object-scale-down overflow-x-hidden rounded-full ring-2 ring-white" src="{{asset('/storage/images/'.Auth::user()->image)}}" alt="Profile Picture">
                </div>
