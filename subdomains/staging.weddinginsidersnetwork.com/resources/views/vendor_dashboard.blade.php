              ...
              <div class="relative flex flex-col min-w-0 break-words rounded-3xl bg-clip-border">
                <div class="flex-auto p-4">
                    <div class="flex-none max-w-full">
                      ...
                      <p class="text-sm underline"><span><a href="/vendor/insights">How do I improve my rankings?</a></span></p>
                    </div>
                </div>
              </div>
            </div>
                        ...
                        <table class="w-[90%] mx-auto border-win-light">
                          <tbody class="border-0">
                            @if(count($data["clients"]) == 0)
                              ...
                              <div class="mx-5 p-4 my-4 h-48 flex flex-col justify-center items-center border border-dashed border-black rounded-xl text-center md:col-span-2 lg:col-span-5">
                                <a href="/vendor/couples" class="py-1 px-4 text-sm font-medium rounded-lg bg-win-blue text-white">Find Clients</a>
                              </div>
                            @endif
                            @foreach($data["clients"] as $client)
                            <tr class="border-b-4 border-win-light current-client-row">
                              ...
                              <td class="whitespace-nowrap">
                                <div class="pl-2 py-1.5 text-center">
                                  <a class="inline-flex items-center gap-x-1 text-sm text-white bg-win-blue px-3 py-[0.125rem] font-medium rounded-lg" href="/client/profile/{{ $client->uuid }}">
                                    View
                                  </a>
                                </div>
                              </td>
                        ...
                        <table class="w-[90%] mx-auto border-win-light" >
                          <tbody class="border-0 max-h-[50vh] lg:max-h-[75vh] overflow-auto">
                            @if(count($data["connections"]) == 0)
                              <div class="mx-5 p-4 my-4 h-48 flex flex-col justify-center items-center border border-dashed border-black rounded-xl text-center md:col-span-2 lg:col-span-5">
                                <a href="/vendor/create/vendors" class="py-1 px-4 text-sm font-medium rounded-lg bg-win-blue text-white">Refer Vendors</a>
                              </div>
                            @endif
                      ...
                      <div class="bg-white rounded-3xl shadow-sm overflow-hidden">
                        ...
                        <table class="w-[90%] mx-auto pb-4" >
                          <tbody class="border-0 max-h-[50vh] lg:max-h-[75vh] overflow-auto max-w-full">
                            @if(count($data["recentConversations"]) == 0)
                ...
                <div class="mt-3 space-x-1 md:space-x-4 mx-auto">
                  ...
                  <a class="hs-tooltip inline-flex justify-center items-center size-16 md:size-16 border-2 border-win-purple rounded-lg disabled:opacity-50 disabled:pointer-events-none" href="#">
                    ...
                    <span class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 transition-opacity inline-block absolute invisible z-10 py-1 px-2 bg-black text-sm font-medium text-white rounded shadow-sm" role="tooltip">
                      Earned badges help build your rankings in WIN. Visit “View Insights” to learn more.
                    </span>
                  </a>
                  @endforeach
                </div>
