...
class TimelineToolController extends Controller
{
    ...
    private const SOURCE_RELATIVE = 'proyecto_bodas_material_extra/WIN Timeline Tool 3-18-26.html';
     ...
     */
    private function renderTimelineView(string $sourcePath, ?string $draftPayload, array $routes): View
    {
        $timelineHtml = WinTimelineToolHtmlPatcher::apply(file_get_contents($sourcePath));
