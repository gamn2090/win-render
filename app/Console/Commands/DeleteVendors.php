...
class DeleteVendors extends Command
{
    /**
    ...
    public function handle()
    {
        foreach ($this->argument('ids') as $id) {
            ...
            try {
                ...
                $this->error("Vendor {$id} could not be deleted, rolled back: " . $e->getMessage());
            }
        }
    }
    ...
    protected function deleteVendor(Vendor $vendor): void
    {
        ...
        // rolls back everything for this vendor instead of leaving orphaned
