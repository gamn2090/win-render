      ...
      <div class="bg-[#EDE9F5] lg:mx-8 rounded-3xl pb-8">
          <div class="w-full px-6 py-6 container mx-auto">
            <div id="notification-bar" class="flex flex-wrap bg-white p-4 lg:px-8 lg:pt-8 lg:pb-6 rounded-3xl text-center">
              @if(!Auth::guard('web')->user()->isInNetwork())
              <div id="network-status" class="top-[1rem] right-[6rem]">
                  <span class="py-1 px-2 inline-flex items-center gap-x-1 font-bold bg-win-light text-black rounded-full">
              ...
              @else
              <div id="network-status" class="top-[1rem] right-[6rem]">
                  <span class="py-1 px-2 inline-flex items-center gap-x-1 font-bold bg-win-purple text-white rounded-full">
                    <svg class="flex-shrink-0 size-3 md:size-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z"/><path d="m9 12 2 2 4-4"/></svg>
                    In network
                  </span>
              </div>
              @endif
                ...
                <div id="savings-card" class="relative flex flex-col min-w-0 break-words rounded-3xl bg-clip-border">
                  <div class="flex-auto p-4">
                      <div class="flex-none max-w-full">
                        ...
                        @else
                        <span class="py-2 px-3 inline-flex items-center gap-x-1 font-semibold bg-purple-win text-win-purple rounded-full text-sm">
                          <svg class="flex-shrink-0 size-3 md:size-8" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z"/><path d="m9 12 2 2 4-4"/></svg>
            ...
            <div class="grid lg:grid-cols-2 xl:grid-cols-4 mt-8 -mx-2">
              ...
              <div id="vendor-status-card" class="rounded-3xl bg-white min-h-96 col-span-1 m-2">
                <div class="overflow-x-hidden min-h-full min-w-full">
                  <div class="px-6 pt-6 grid gap-3 md:flex md:justify-between md:items-center">
                    <h2 class="subheading mb-2">
                      Vendor Status
                  ...
                  <div class="flex justify-center w-[90%] mx-auto py-6 border rounded-xl border-win-light border-4">
                    ...
                    <div class="flex inline-flex px-2">
                      ...
                      {{ Auth::user()->vendorsCount() }} Vendors
                      <br>
                      In Network
                      </p>
                    </div>
            ...
            <div class="bg-white p-4 lg:p-8 rounded-3xl mt-4 md:mt-8">
              <div class="w-full mb-4">
                <h3><span class="subheading">All Vendor Search Status:</span> <a href="/search/vendors" class="px-2 py-1 bg-win-blue text-white text-sm rounded-lg sm:ml-1 lg:ml-2">Search Vendors</a></h3>
              </div>
            ...
            <div class="bg-white p-4 lg:p-8 rounded-3xl mt-4 md:mt-8">
              ...
              @endphp
              <div class="w-full mb-4">
                <h3 class="subheading">Your Wedding Team:</h3>
              </div>
