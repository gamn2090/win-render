...
<html>
  <head>
    ...
    <script>
        ...
        window.attachmentUploadUrl = "{{ Auth::user()->userType() === 'vendor' ? route('vendor.message.attachment.upload') : route('client.message.attachment.upload') }}";
    </script>
      ...
      <!-- Sidebar -->
        ...
        <div id="chatContent" class="relative w-full lg:ps-16 overflow-y-scroll h-[85%]">
          ...
          <div class="fixed z-20 bottom-0 right-10 my-3">
            <div class="flex flex-col bg-white rounded-xl shadow-sm w-full px-4 py-2 min-w-[75vw]">
              <div id="attachmentPreview" class="hidden mb-2 items-center justify-between gap-3 bg-gray-50 border border-gray-200 rounded-lg px-3 py-2">
                <div class="flex items-center gap-2 min-w-0">
                  <svg class="w-5 h-5 text-win-purple flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                  </svg>
                  <span id="attachmentPreviewName" class="text-sm text-gray-700 truncate"></span>
                  <span id="attachmentPreviewSize" class="text-xs text-gray-500 flex-shrink-0"></span>
                </div>
                <button id="attachmentRemoveBtn" type="button" class="text-gray-500 hover:text-red-500 flex-shrink-0" aria-label="Remove attachment">
              ...
              <div class="flex flex-row items-center h-12">
                <div>
                  <button
                    id="attachmentBtn" type="button"
                    class="flex items-center justify-center text-gray-500 hover:text-win-purple p-2 rounded-lg flex-shrink-0"
                    title="Attach a PDF"
                  >
                  ...
                  <input id="attachmentInput" type="file" accept="application/pdf,.pdf" class="hidden" />
                </div>
