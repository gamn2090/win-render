...
@include('layouts.vendor_navigation', ['page' => 'account_settings'])
...
<main class="relative transition-all duration-200 ease-in-out">
  <div class="vd-main">
    ...
    <section class="vd-edit-card vd-settings-section">
      ...
      <form method="POST" action="{{ route('vendor.password.update') }}" class="vd-edit-form">
        @csrf
        @method('put')
...
<div id="vd-delete-account-modal" class="vd-modal-overlay" role="dialog" aria-modal="true" aria-labelledby="vd-delete-account-title">
  <div class="vd-modal">
    ...
    <form method="POST" action="{{ route('vendor.profile.destroy') }}" class="vd-modal__body" style="width: 100%;">
      @csrf
      @method('delete')
