...
<body class="antialiased overflow-x-hidden bg-win-light w-screen">
        ...
        <div class="min-h-[85vh] max-h-[85vh] items-stretch">
            <div class="w-full mx-auto px-4 lg:px-16 xl:px-32 md:w-3/4 md:content-center overflow-hidden min-h-[85vh] text-white">
                <div class="text-center my-auto mx-auto">
                    ...
                    <div class="mx-auto rounded-lg bg-win-light p-4 md:w-3/4 2xl:w-1/2 my-4">
                        <div class="md:grid md:grid-cols-7">
                            <div class="md:col-span-3 hidden md:block p-2 lg:p-4 md:content-center">
                                <img src="/assets/img/home/win-welcome-1.png" class="rounded-tl-3xl rounded-br-3xl h-auto max-h-[15rem] mx-auto my-auto">
                            </div>
                            <div class="md:col-span-4 text-center p-2 lg:p-4 text-black md:content-center">
                                <h3 class="subheading">Wedding Planning with Purpose</h3>
                                <p>Merit-based vendor matchmaking ❤️ The industry's source for pre-vetted curated vendors - Match with vendors based on your vision & budget.</p>
    ...
    <div class="min-w-screen bg-win-light">
        <div class="py-16 md:py-32">
            <div class="text-center my-auto mx-auto md:max-w-[65%] px-4">
    ...
    <div class="mb-16 max-w-screen overflow-hidden">
            <div class="min-w-[100vw] py-12 relative z-20">
                <div class="grid md:grid-cols-2 gap-x-16 lg:max-w-[75%] mx-auto">
                    <div class="text-center p-8 lg:p-12 bg-win-lavender rounded-xl">
                        <h3 class="headline-small text-win-red">Free For Couples</h3>
                        <p class="subheading mt-8 lg:mt-10 lg:max-w-[75%] mx-auto">Easily filter through wedding vendors — featured for their reputation and not because they paid for a higher listing. The best way to support small businesses while tapping into a curated, transparent list of talented vendors that fit your needs.</p>
                        <img src="assets/img/home/laptop-1.png" class="-my-6">
                        <div class="min-w-full mx-auto items-center md:hidden mt-4 mb-8">
                            <a href="/search" class="mx-auto button-text py-2 px-10 font-semibold rounded-lg bg-win-orange text-white">
                    ...
                    <div class="text-center p-8 lg:p-12 bg-win-lavender rounded-xl">
                        ...
                        <img src="assets/img/home/laptop-2.png" class="-my-6">
                        <div class="min-w-full mx-auto items-center md:hidden my-4">
                            <a href="{{ route('vendor.register')}}" class="mx-auto button-text py-2 px-10 font-semibold rounded-lg bg-win-orange text-white">
                                Learn More
                            </a>
                        </div>
                    </div>
                    <div class="text-center hidden md:block -mt-10">
                        <div class="min-w-full mx-auto items-center">
                            <a href="/search" class="mx-auto py-2 px-10 font-semibold rounded-lg bg-win-orange text-white">
                                Explore our Community
                            </a>
                        </div>
                    </div>
                    <div class="text-center hidden md:block -mt-10">
                        <div class="min-w-full mx-auto items-center">
                            <a href="{{ route('vendor.register')}}" class="mx-auto py-2 px-10 font-semibold rounded-lg bg-win-orange text-white">
                            Learn More
                            </a>
                        </div>
                    </div>
    ...
    <div class="min-w-screen bg-white">
        <div class="h-full pb-16 px-4 md:pb-32 lg:pb-48" style="background-image:url('/assets/img/WIN-Large-Confetti-Pattern.jpg');">
            <div class="text-center my-auto mx-auto md:max-w-[85%] pt-8">
                ...
                <div class="lg:grid gap-8 lg:grid-cols-7 mt-4">
                    ...
                    <div class="grid gap-x-4 md:grid-cols-2 -mb-4 md:mb-0 text-left col-span-4">
                        <div class="w-full sm:px-8 mb-4 bg-win-light rounded-3xl border-4">
                            <div class="mb-12">
        ...
        <div class="bg-[#FFD3FB] h-full pb-16">
            <div class="my-auto mx-auto px-4 max-w-[85%] lg:max-w-[65%] pt-16">
                ...
                <div class="lg:grid grid-cols-2 gap-8 my-4 lg:my-8">
                    ...
                    <img src="/assets/img/home/features-2.avif" class="rounded-xl h-48 lg:h-64 mx-auto border-4" data-aos="flip-right">
                </div>
                <div class="border-dotted border-b-2" data-aos="fade-right"></div>
                <div class="lg:grid grid-cols-2 gap-8 my-4 lg:my-8">
    ...
    <div class="w-screen lg:max-w-[85%] bg-win-light p-16 my-16 mx-auto rounded-xl bg-[url('/assets/img/home/vendors-for-wedding(s)-1.jpg')] bg-no-repeat bg-cover">
        <div class="lg:grid grid-cols-2">
            <div class="rounded-xl bg-white/50 border-4 w-auto py-12">
                ...
                <div class="text-center button-text mt-4 space-y-4">
                    <div class="text-center">
                        <a href="/search?type=12" class="px-6 py-2 bg-win-lavender rounded-lg">Planner →</a>
                    </div>
                    <div class="text-center">
                        <a href="/search?type=2" class="px-6 py-2 bg-win-lavender rounded-lg">Venue →</a>
                    </div>
                    <div class="text-center">
                        <a href="/search?type=9" class="px-6 py-2 bg-win-lavender rounded-lg">Photographer →</a>
                    </div>
                    <div class="text-center">
                        <a href="/search?type=13" class="px-6 py-2 bg-win-lavender rounded-lg">Videographer →</a>
                    </div>
                    <div class="text-center">
                        <a href="/search?type=7" class="px-6 py-2 bg-win-lavender rounded-lg">Hair and makeup →</a>
                    </div>
                    <div class="text-center">
                        <a href="/search?type=5" class="px-6 py-2 bg-win-lavender rounded-lg">DJ →</a>
                    </div>
                    <div class="text-center">
                        <a href="/search?type=4" class="px-6 py-2 bg-win-lavender rounded-lg">Catering →</a>
                    </div>
                    <div class="text-center">
                        <a href="/search" class="px-6 py-2 bg-win-lavender rounded-lg">View all →</a>
                    </div>
                </div>
            </div>
            <div class="hidden lg:block mx-16">
                <div class="my-16">
                    <p class="bg-win-purple rounded-t-xl rounded-br-xl p-4 text-white inline subheading">Hi there!</p>
                </div>
                <div class="my-16 text-right">
                    <p class="bg-win-blue rounded-t-xl rounded-bl-xl p-4 text-white inline subheading">Welcome to WIN!</p>
                </div>
                <div class="my-16">
                    <p class="bg-win-purple rounded-t-xl rounded-br-xl p-4 text-white inline subheading">Thank you!</p>
                </div>
            </div>
        </div>
