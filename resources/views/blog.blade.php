...
<body class="antialiased overflow-x-hidden bg-white">
    <div class="min-w-screen bg-win-light">
        <div class="min-h-[80vh] mx-auto flex justify-center max-w-screen overflow-x-hidden">
            <img class="absolute z-0 left-[20%] top-[20%]" src="/assets/img/blog/blog-confetti.PNG">
            <div class="text-center mx-auto lg:max-w-[30%] min-h-[80vh] flex inline-flex items-center justify-center">
    ...
    <div class="min-w-screen mb-[-5%] relative z-10" style="background-image:url('/assets/img/blog/important.png'); background-size:cover; background-position: center;">
        <div class="min-h-[75vh] h-full py-32 flex items-center justify-center">
            <div class="text-center my-auto mx-auto md:max-w-[33%]">
                <h1 class="headline-large text-white mb-2">An important
                heading goes here</h1>
            </div>
        </div>
    </div>
    <div class="md:mx-16 bg-win-light">
        <div class="md:grid md:grid-cols-2 md:gap-8 lg:max-w-[65%] mx-auto mb-12 lg:mb-24">
            <div class="text-center relative z-50">
                <img class="rounded-tl-3xl mb-4 mx-auto h-[60vh]" src="/assets/img/blog/article-1.png">
                <h3 class="body-copy font-bold text-win-red mt-8">VENDORS</h3>
                <p class="subheading my-8 lg:my-10 md:max-w-[35%] mx-auto">This is where your
                    blog heading will
                    go. Right here in
                    this spot.</p>
                <div class="my-6 min-w-full flex items-center">
            ...
            <div class="text-center relative z-50">
                <img class="rounded-tl-3xl mb-4 mx-auto h-[60vh]" src="/assets/img/blog/article-2.jpg">
                <h3 class="body-copy font-bold text-win-red mt-8">TRENDING</h3>
                <p class="subheading my-8 lg:my-10 md:max-w-[35%] mx-auto">This is where your
                    blog heading will
                    go. Right here in
        ...
        <div class="md:grid md:grid-cols-2 md:gap-8 lg:max-w-[65%] mx-auto">
            <div class="text-center relative z-50">
                <img class="rounded-tl-3xl mb-4 mx-auto h-[60vh]" src="/assets/img/blog/article-1.png">
                <h3 class="body-copy font-bold text-win-red mt-8">VENDORS</h3>
                <p class="subheading my-8 lg:my-10 md:max-w-[35%] mx-auto">This is where your
