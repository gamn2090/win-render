  ...
  function dashboardTutorial(){
    ...
    return intro.setOptions({
      steps: [
        ...
        {
          element: document.querySelector('#network-status'),
          title: 'Task #3: Track Your Network Status',
          intro: `Unlock Network Benefits:<br>
          <ul>
            <li>Book your first vendor to join the network and access exclusive perks.</li>
            <li>Your eligibility for vendor discounts will appear once you book your first in-network vendor.</li>
          </ul>`
        },
        {
          element: document.querySelector('#savings-card'),
          title: 'Task #4: Preferred Pricing – Savings Worth Celebrating',
          intro: `<ul>
        ...
        },
        {
          ...
          title: 'Task #6: Vendor Status – Manage Your Search with Ease',
        ...
        },
        {
          ...
          title: 'Task #7: Inbox &amp; Wedding Appointments',
